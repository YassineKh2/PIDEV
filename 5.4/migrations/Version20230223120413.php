 ...
 */
final class Version20230223120413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE session CHANGE difficulte difficulte VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE session CHANGE difficulte difficulte VARCHAR(255) DEFAULT NULL');
    }
}
