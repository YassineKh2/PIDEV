 ...
 */
final class Version20230223120749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE despense ADD CONSTRAINT FK_EB12D333613FECDF FOREIGN KEY (session_id) REFERENCES session (id) ON DELETE SET NULL');
